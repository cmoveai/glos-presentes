...
export const INITIAL_BRANDS: ProductBrand[] = [
  {
    ...
    name: "glos. atelier",
    slug: "glos-atelier",
    description: "Linha própria artesanal de presentes afetivos, velas, papéis e porcelanas.",
    active: true,
    featured: true,
  },
  {
...
export async function generateProductDraft(prompt: string): Promise<Partial<Product>> {
  ...
  return {
    ...
    shortDescription: `Uma seleção acolhedora pensada para transformar momentos simples em memórias eternas com a curadoria da glos.`,
