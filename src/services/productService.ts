...
export const INITIAL_GLOS_PRODUCTS: Product[] = [
  {
    ...
    customizationOptions: {
      ...
      allowMessage: true,
      allowColor: false,
      instructions: "Após a confirmação da compra, envie seus arquivos e fotos em Minha Conta → Meus Pedidos.",
  ...
  },
  {
    ...
    customizationOptions: {
      ...
      allowMessage: true,
      allowColor: true,
      instructions: "Escolha a cor da alça/interior. Após a confirmação da compra, envie seus arquivos e fotos em Minha Conta → Meus Pedidos.",
      requirePhotoUpload: true,
    },
    brandId: "brand-glos",
    brandName: "Nivah Atelier",
